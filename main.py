...
class Bemvindo:
    def __init__(self, master=None):
        ...
        self.intro_images1 = Image.open("C:/Jogoprincipal/Fotospy/fotoinicial.png")
        self.intro_images2 = Image.open("C:/Jogoprincipal/Fotospy/foto1.png")
        self.intro_images3 = Image.open("C:/Jogoprincipal/Fotospy/foto2.png")
        self.intro_images4 = Image.open("C:/Jogoprincipal/Fotospy/foto3.png")
        ...
        self.imgatual = "C:/Jogoprincipal/Fotospy/fotoinicial.png"
        ...
        self.img_fundo = Image.open("C:/Jogoprincipal/Fotospy/fundo_fases.png")
    ...
    def menu_inicial(self):
        ...
        self.img = Image.open("C:/Jogoprincipal/Fotospy/fundo_oficial_fase1.png")
        self.imgmenutk = ImageTk.PhotoImage(self.img)

        self.containerfundo.config(image=self.imgmenutk)
        self.imgatual = "C:/Jogoprincipal/Fotospy/fundo_oficial_fase1.png"
        ...
        self.conteudo_regras.insert(END, '- O Competidor deve ter entre 17 e 29 anos.\n', 'normal')
        self.conteudo_regras.insert(END, '- A matrícula tem 8 dígitos e os três primeiros indicam um ano de 2021 até 2025 e o semestre de ingresso\n', 'normal')
        ...
        self.conteudo_regras.insert(END, 'Universidades válidas: UFSC - USP - UFRJ - UFMG - UNICAMP - UFPE - UFRGS - UFPR - UnB - FURG - UFBA - UFAM - IME-USP - ITA - PUC-RS - FURB - PUC-PR - Mackenzie - FAAP - Feevale - Unisul\n\n', 'normal')
        self.conteudo_regras.insert(END, 'Linguagens válidas: Python - C/C++ - Java - JavaScript - Go - Rust - TypeScript - Kotlin - Perl - Bash\n\n', 'normal')
        ...
        self.conteudo_regras.insert(END, '- A experiência é um número considerado válido se a diferença entre a idade do competidor e ela for maior ou igual a 17.\n', 'normal')
    ...
    def iniciar_nova_partida(self):
        ...
        self.imgatualfases = "C:/Jogoprincipal/Fotospy/fundo_fases.png"
        self.game_frame.place(x=0, y=0, relwidth=1, relheight=1)
    ...
    def processar_decisao(self, aceitou_jogador):
        ...
        if aceitou_jogador:
            ...
            if competidor_tem_erros:
                ...
                self.ultimo = 0
        if self.ultimo == 1:
            self.imgatualfases = "C:/Jogoprincipal/Fotospy/fundo_correto.png"
            self.redimensionarfases()
            self.fase_status.config(bg ="#09c739")
            self.competidor.config(bg = "#09c739")
        else: 
            self.imgatualfases = "C:/Jogoprincipal/Fotospy/fundo_errado.png"
            self.redimensionarfases()
    ...
    def mostrar_tela_final(self, foto):
        ...
        self.img_final_string = f"C:/Jogoprincipal/Fotospy/{foto}.png"
        self.img_final = Image.open(f"C:/Jogoprincipal/Fotospy/{foto}.png")
